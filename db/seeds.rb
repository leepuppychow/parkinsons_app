...
therapist1 = Therapist.create(first_name: "Nida", last_name: "Tansinsin", therapy_type: "PT", years_experience: 10)
therapist2 = Therapist.create(first_name: "MC", last_name: "Cox", therapy_type: "OT", years_experience: 8)
